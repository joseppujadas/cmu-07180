...
class Simulator:
    ...
    def doAction (self, action):
        ...
        # Can pick up victim if at that location and not holding anyone
            ...
            return (self._agentLocn, PICKUP_COST) # Same cost, just no effect if not applicable here
        ...
        # Can put down victim if at that location and holding someone
            ...
            return (self._agentLocn, PUTDOWN_COST) # Same cost, just no effect if not applicable here
        else:
